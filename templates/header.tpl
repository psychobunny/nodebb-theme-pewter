		...
		<div class="container">
			...
			<div id="slidemenu">
				<ul id="main-nav" class="nav navbar-nav">
					<li>
						<a href="{relative_path}/"><i class="fa fa-fw fa-home" title="[[global:header.unread]]"></i><span class="hidden-xs-inline"> {title}</span></a>
					</li>
					<li class="nodebb-loggedin">
						<a href="{relative_path}/unread"><i id="unread-count" class="fa fa-fw fa-inbox" data-content="0" title="[[global:header.unread]]"></i><span class="hidden-xs-inline"> [[global:header.unread]]</span></a>
					</li>
					<li>
						<a href="{relative_path}/recent"><i class="fa fa-fw fa-clock-o" title="[[global:header.recent]]"></i><span class="hidden-xs-inline"> [[global:header.recent]]</span></a>
					</li>
					<li>
						<a href="{relative_path}/popular"><i class="fa fa-fw fa-fire" title="[[global:header.popular]]"></i><span class="hidden-xs-inline"> [[global:header.popular]]</span></a>
					</li>
					<li>
						<a href="{relative_path}/users"><i class="fa fa-fw fa-users" title="[[global:header.users]]"></i><span class="hidden-xs-inline"> [[global:header.users]]</span></a>
					</li>
					<!-- IF isAdmin -->
					<li>
						<a href="{relative_path}/admin"><i class="fa fa-fw fa-cogs" title="[[global:header.admin]]"></i><span class="hidden-xs-inline"> [[global:header.admin]]</span></a>
					</li>
					<!-- ENDIF isAdmin -->
			...
			<div class="container">
				...
				<div class="pull-right profile">
					<div class="avatar pull-left">
						<img src="http://1.gravatar.com/avatar/177d180983be7a2c95a4dbe7451abeba?s=95&d=&r=PG" />
					</div>
					<div class="pull-left welcome">
						<p>Welcome, <strong>anonymous</strong>.</p>
						<p>Sign in to claim your identity and join the conversation.</p>
					</div>
					<div class="clear auth">
